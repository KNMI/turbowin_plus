...
public class mystationdata extends javax.swing.JFrame {
   ...
   private void initComponents() {
      ...
      jLabel6.setText("wind speed units:");
      ...
      jLabel20.setText("*Summer Load Line              **negative if SLL is below water line");
      ...
      jLabel22.setText("* select always \"no\" if a barometer or AWS is connected");
   ...
   private void lees_iso_landen_codes()
   {
    ...
    private void OK_button_actionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OK_button_actionPerformed
               ...
               ) )   // PTB220 or PTB330 or MintakaDuo or Mintaka Star USB or Mintaka Star WiFi AP or Mintaka Star WiFi station
       {
          ...
          {
             info += "the barometer instrument connected (see: Maintenance -> WiFi instrument connection)";
          }
          else
          {
             info += "the barometer instrument connected (see: Maintenance -> Serial/USB connection)";
          }
       }
       else if ( (main.pressure_reading_msl_yes_no.equals(main.PRESSURE_READING_MSL_YES) == true) &&
                 (main.RS232_connection_mode == 3) )            // EUCAWS
       {
          info = "If there is an AWS connected please select: \"does the reading indicate MSL pressure = no\"\n";
          info += "If the reading indicates MSL pressure and there is no AWS connected to TurboWin+ please deselect first \n";
          info += "the EUCOS AWS instrument connected (see: Maintenance -> Serial/USB connection)";
       }
